...
// Função pra adicionar a classe 'active' ao link clicado
function activelink() {
...
if (isTyping) {
    ...
    setTimeout(animateText, 300); // Intervalo de tempo para a animação
}
// Função para atualizar a cor do título com base no tema
function updateTextColor() {
    currentColor = document.documentElement.classList.contains('light') ? 'black' : 'white';
    titleElement.style.color = currentColor;
}
...
setTimeout(() => {
    hommeSection.style.opacity = 1;
    homeSection.style.transform = 'translateY(0)';
}, 100);  // Tempo para iniciar a animação da seção home
